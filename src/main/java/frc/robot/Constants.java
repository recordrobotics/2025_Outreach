...
public final class Constants {
  ...
  public final class Twerk {
    ...
    public static final double TWERK_SPEED = 0.1; // meters
  ...
  public final class RobotState {
     ...
     *
     * <p>WARNING! ONLY ENABLE THIS IF RUNNING A SINGLE UNIT TEST
     *
     * <p>RUNNING TESTS IN PARALLEL IS NOT SUPPORTED Example: {@code ./gradlew test --tests
     * "*ReefAutoScoreTestCases`$Blue4"}
     */
